package com.example.aws.springbootpostgresaws.service;
...
import com.example.aws.springbootpostgresaws.exception.FileArchiveServiceException;
...
public class FileArchiveService {
    ...
    private static final String S3_BUCKET_NAME = "kurkul-java-springboot-postgres-aws-demo";
     ...
     * @throws IOException
     */
    public EmployeeImage saveFileToS3(MultipartFile multipartFile) throws FileArchiveServiceException {
        ...
        try{
            ...
            return new EmployeeImage(key, signedUrl.toString());
        }
        catch(Exception ex){
     ...
     * @param customerImage
     */
    public void deleteImageFromS3(EmployeeImage customerImage){
